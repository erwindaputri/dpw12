...
Route::get('fruits', [ClientController::class, 'showproducts'] );
Route::get('blog', [ClientController::class, 'showclient'] );
Route::post('shop/filter', [ClientController::class, 'filter']);
Route::post('shop/filter2', [ClientController::class, 'filter2']);
Route::get('sayur/{produk}', [ClientController::class, 'showproducts']);
